...
public class BoardSearchImpl extends QuerydslRepositorySupport implements BoardSearch{
    ...
    public Page<Board> search1(Pageable pageable) {
        ...
        JPQLQuery<Board> query = from(board); //select  * frmo board;
    ...
    @Override
    public Page<BoardDTO> searchAllWithReplyCount(String[] types, String keyword, Pageable pageable) {
        QBoard board = QBoard.board;
        ...
        List<BoardDTO> boardList = dtoQuery.fetch();
